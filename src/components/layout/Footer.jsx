	...
	<div className="footerclass">
		<footer className="page-footer font-small stylish-color-dark pt-4 bg-dark text-white" id="footer">
			<div className="container text-center text-md-left">
				<div className="row">
					<div className="col-md-6  ">
						<h5 className="font-weight-bold text-uppercase mt-3 mb-4 ">Social Schedular</h5>
					...
					<div className="col-md-6 ">
						<ul className="list-unstyled list-inline text-center py-2">
							<li className="list-inline-item btn btn-danger btn-rounded">
								<Link to="/register" className="color-wt">Contact Us!</Link>
							</li>
						</ul>
					</div>
			...
			<ul className="list-unstyled list-inline text-center">
				...
				<li className="list-inline-item">
					<a className="fb-ic" href="https://github.com/anushbhatia/Social-Scheduler" >
